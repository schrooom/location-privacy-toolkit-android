...
class ExclusionZoneFragment : Fragment() {
    ...
    companion object {
        ...
        private const val TILE_SERVER =
            "https://tiles.beemo.eu/styles/default/style.json" //"https://demotiles.maplibre.org/style.json"
    }
}